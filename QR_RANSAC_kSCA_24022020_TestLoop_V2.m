...
Sigma=1e-6; % Parameter controls the standard deviation of normal noise over the
...
f=nchoosek(n-1,k-1);
[ComplementOrthofSubSpaces_A,Ahat]=FnSubSpaceFind_Mixing_Final(ComplementOrthofSubSpaces,ThBBC,f,n,Th_RansacMixing,p,MaxIterEst);
%% Error estimation
