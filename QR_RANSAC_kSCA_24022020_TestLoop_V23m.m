...
mAll=[3 4]; % The number of sensors a.k.a the ambient dimension
nAll=[10 8]; % The number of sources
% mAll=[4]; % The number of sensors a.k.a the ambient dimension
% nAll=[8]; % The number of sources

SigmaAll=[0 1e-4]; % Parameter controls the standard deviation of normal noise over the
