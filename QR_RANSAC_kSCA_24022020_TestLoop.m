...
%% Preliminaries
for LoopN=1:100
m=5; % The number of sensors a.k.a the ambient dimension
n=6; % The number of sources
k=4; % The number of acitive source in each time point (nonzero elements
...
T= c*200; %1000; % The Number of data poins a.k.a the number of samples (time points)
...
f=nchoosek(n-1,k-1);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing10(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,f,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc,n,A);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing6(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,f,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc2,n,A);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing7(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc,n,A);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing11(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc,n,A);
[QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing5New22(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,f,Iter_MixingId,SubspaceInds,DistFunc,DegFunc,FitFunc,n,A);

% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing5New(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc,FitFunc,n,A);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2_1,ConnMat2,Ahat2]=FnSubSpaceFind_Mixing5New3(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc,FitFunc,n,A);

%  [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing5New2(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc,FitFunc,n,A);
%  [Ahat]=FnCS2(ComplementOrthofSubSpaces,m,[],Th3*1000);%Alg3:CS2

% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing5(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc,n,A);
% [QRSubspaceInds2,Clusters2,SubSpaces2,ComplementOrthofSubSpaces2,ConnMat2,Ahat]=FnSubSpaceFind_Mixing5(ComplementOrthofSubSpaces,ThBBC,Th_RansacMixing,k,Iter_MixingId,SubspaceInds,DistFunc,DegFunc2,FitFunc,n,A);
...
MIE(LoopN)=MixingIdentificatioError;
